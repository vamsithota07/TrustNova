          ...
          <Container>
            <div className="flex items-center justify-between min-h-[64px] md:min-h-[80px] lg:min-h-[96px]">
              ...
              <div className="hidden lg:block shrink-0">
                <Link
                  href="/contact"
                  className={`inline-flex items-center justify-center min-h-[44px] px-6 py-2.5 border border-brand-blue text-sm font-semibold rounded-md transition-all duration-300 hover:shadow-blue-glow active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-brand-blue whitespace-nowrap ${
                    isActive("/contact")
                      ? "bg-brand-blue text-white"
                      : "text-brand-blue bg-transparent hover:bg-brand-blue hover:text-white"
                  }`}
                >
                  Contact
                </Link>
            ...
            <nav className="flex flex-col w-full">
              ...
              <div className="px-6 py-4">
                <Link
                  href="/contact"
                  onClick={closeDrawer}
                  className={`inline-flex items-center justify-center min-h-[44px] w-full px-6 py-3 border border-brand-blue font-semibold rounded-md transition-all duration-300 active:scale-[0.98] ${
                    isActive("/contact")
                      ? "bg-brand-blue text-white"

  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-6 right-5 z-40 flex items-center gap-2 rounded-full bg-brand-blue text-white px-4 py-3 text-sm font-semibold shadow-[0_8px_24px_rgba(107,130,168,0.35)]"
